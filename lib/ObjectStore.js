class ObjectStore {
    ...
    addOne(data) {
        ...
        request.onsuccess = function (e) {
            if(DEBUG) console.log('added rrecord');
            
        }
        transaction.oncomplete = function () {
            if(DEBUG) console.log('added record');
        }
    ...
    deleteOne(index) {
        ...
        transaction.oncomplete = function () {
            if(DEBUG) console.log("Record deleted");
        };
        ...
        request.onsuccess = function () {
            ...
            if (existingRecord) {
                ...
                updateRequest.onsuccess = function () {
                    if(DEBUG) console.log("Record updated");
                };
