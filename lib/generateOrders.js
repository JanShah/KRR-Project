...
function getCategories() {
    const categories = [
        new Category("Tools", 0.2, [5, 75], [0.3, 0.7], [7000, 150000], [5, 10, 12, 24]),
        new Category("Books", 0.3, [3, 7], [0.2, 0.5], [1500, 200000], [1, 5, 20]),
        new Category("Gifts", 0.7, [4, 17], [0.3, 1.2], [15000, 750000], [6, 10, 12, 24]),
        new Category("Fashion", 0.6, [5, 20], [0.5, 0.9], [45000, 1000000], [1, 3, 6, 12]),
        new Category("Electronics", 0.7, [15, 190], [0.1, 0.2], [10000, 1000000], [2, 5]),
    ];
    return categories;
}
